...
void HariMain(void){
   ...
   putfont8(binfo->vram,binfo->scrnx,16,8,0xFFFFFF,hankaku+'B'*16);
   putfont8(binfo->vram,binfo->scrnx,24,8,0xFFFFFF,hankaku+'C'*16);
   putfont8(binfo->vram,binfo->scrnx,40,8,0xFFFFFF,hankaku+'1'*16);
   putfont8(binfo->vram,binfo->scrnx,48,8,0xFFFFFF,hankaku+'2'*16);
   putfont8(binfo->vram,binfo->scrnx,56,8,0xFFFFFF,hankaku+'3'*16);
